...
async def advantage_spoll_choker(bot, query):
    ...
    await query.answer('ᴄʜᴇᴄᴋɪɴɢ ꜰɪʟᴇ ᴏɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ...//')
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('ᴛʜɪꜱ ᴍᴏᴠɪᴇ ɪꜱ ɴᴏᴛ ʏᴇᴛ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ᴀᴅᴅᴇᴅ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ 💌')
